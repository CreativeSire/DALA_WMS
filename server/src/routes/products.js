...
const productSchema = z.object({
  ...
  internal_barcode_value: z.string().optional().default(''),
  product_aliases: z.array(z.string().min(1)).optional().default([]),
  base_uom_label: z.string().optional().default('ctn'),
  alt_uom_label: z.string().optional().default(''),
  units_per_pack: z.coerce.number().positive().default(1),
  is_vatable: z.boolean().optional().default(false),
  name: z.string().min(2),
